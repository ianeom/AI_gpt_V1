# Let's create a perfectly formatted main.py file containing the fully corrected code for the user.
# The user wants the full code for OpenAI GPT-4o-mini that they can copy and paste directly into main.py.
...
# 環境變數設定 (這裡將 API KEY 改為 OPENAI_API_KEY 以配合 OpenAI 官方規範)
...
def get_prompt_and_respond(user_id: str, user_message: str) -> str:
    ...
    # 🟡 第二階段完全體任務內容
        ...
        return (
            ...
            "📚 【本週必修課】\\n"
            "1. 【套裝引導培訓】：練熟入會套裝（PIB）的拆解邏輯，引引導新戰將以「尊爵套裝」進場卡位，現領 $405 美元大紅包，瞬間引爆代數獎金！\\n"
...
"""
    ...
    try:
        # 修正：完美轉換為 OpenAI Chat Completions API 格式與 gpt-4o-mini 模型
...
print("Successfully written to main.py")
